...
from RestructModelings.modeling.meta_arch import GeneralizedRCNN
...
class TestLocate(unittest.TestCase):
    ...
    def test_compress_target(self):
        from RestructModelings.data.transforms import RandomCrop

        name = _convert_target_to_string(RandomCrop)
        # name shouldn't contain 'augmentation_impl'
        self.assertEqual(name, "RestructModelings.data.transforms.RandomCrop")
